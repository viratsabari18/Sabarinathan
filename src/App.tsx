// App.tsx - Updated with creative header section
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      ...
      <main className="relative">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 space-y-20 py-16">
            ...
            >
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                <div className="relative">
                  <div className="relative z-10">
                    <motion.h1 
                      ...
                      className="text-5xl lg:text-6xl font-bold bg-gradient-to-r from-white to-blue-200 bg-clip-text text-transparent mb-4"
                    >
                    ...
                    <motion.h2
                      ...
                      className="text-xl lg:text-2xl text-blue-400 mb-4"
                    >
                    ...
                    >
                      <button 
                        ...
                        className="px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-full font-semibold hover:scale-105 transition-transform text-white shadow-lg"
                      >
                        View Projects
                      </button>
                      <button 
                        onClick={() => document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' })}
                        className="px-6 py-3 border border-blue-600 rounded-full font-semibold hover:bg-blue-600/10 transition-colors text-blue-300 hover:text-blue-200"
                      >
                        Contact Me
                      </button>
                      ...
                      <button 
                        onClick={openResume}
                        className="px-6 py-3 border border-green-600 rounded-full font-semibold hover:bg-green-600/10 transition-colors flex items-center gap-2 text-green-300 hover:text-green-200"
                      >
                ...
                >
                  ...
                  <div className="relative w-full h-96 bg-slate-800/50 backdrop-blur-sm rounded-3xl border border-slate-700/50 p-6 overflow-hidden">
                    ...
                    <div className="relative z-10 h-full flex flex-col justify-center space-y-4">
                      ...
                      >
                        ...
                        <code className="text-blue-300 font-mono text-sm">class <span className="text-cyan-300">MobileDeveloper</span></code>
                      </motion.div>
                      ...
                      >
                        ...
                        <code className="text-gray-400 font-mono text-sm">def <span className="text-green-300">build_app</span>():</code>
                      </motion.div>
                      ...
                      >
                        <code className="text-purple-300 font-mono text-sm">return <span className="text-yellow-300">"Amazing UX"</span></code>
                      </motion.div>
                      ...
                      >
                        ...
                        <code className="text-blue-300 font-mono text-sm">skills = [</code>
                      </motion.div>
                  ...
                  >
                    <div className="flex flex-col items-center text-center p-4 bg-slate-800/50 rounded-xl border border-slate-700 group hover:bg-slate-800/70 transition-all duration-300">
                      <i className="fas fa-mobile-alt text-2xl text-blue-400 mb-2"></i>
                      <h3 className="text-white font-semibold mb-1">Flutter Enthusiastic</h3>
                      <p className="text-gray-400 text-sm">Cross-Platform Development</p>
                    </div>
                    
                    <div className="flex flex-col items-center text-center p-4 bg-slate-800/50 rounded-xl border border-slate-700 hover:bg-slate-800/70 transition-all duration-300">
                    ...
                    <div className="flex flex-col items-center text-center p-4 bg-slate-800/50 rounded-xl border border-slate-700 hover:bg-slate-800/70 transition-all duration-300">
                      <i className="fas fa-palette text-2xl text-green-400 mb-2"></i>
                      <h3 className="text-white font-semibold mb-1">Beautiful UI</h3>
      ...
      <footer className="relative z-10 text-center py-8 text-gray-400 border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-6">
          <p className="text-sm">Built with React, TypeScript, Tailwind & Framer Motion</p>
